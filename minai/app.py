...
UI_TEXTS = {
    ...
    "Norska": {
        ...
        "intro": "Last opp rådataen din i bunnmenyen. TextFabriken forvandler den til salgsfremmende SEO-tekster og lager en ferdig Word-fil for deg!",
        ...
        "expander_label": "📎 Klikk her for å legge inn produktfakta (PDF/TXT/WORD)",
